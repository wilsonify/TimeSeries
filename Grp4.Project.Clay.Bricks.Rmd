...
Even with the first order of differencing applied, we observe that there is still slow residual decay in the ACF plot at a seasonal lag period of 12. This suggests that a seasonal difference should applied.
